    ...
    return (
      ...
      >
        ...
        <p className="text-gray-300 text-lg">
          Deal not found or link has expired.
        </p>
        <a
          href="/"
        ...
        >
          ...
          {highlightMetrics.length > 0 && (
            <div
              ...
              style={{
                gridTemplateColumns: `repeat(${Math.min(highlightMetrics.length, 3)}, 1fr)`,
              }}
            >
          ...
          >
            <p className="text-gray-300 mb-4 text-sm">
              Run this scenario yourself — adjust assumptions and see how
              returns change in real time.
            </p>
            <a
              href="/"
